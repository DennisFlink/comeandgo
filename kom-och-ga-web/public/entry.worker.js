...
new PushManager({
  handlePushEvent: (event) => {
    var _a;
    const message = (_a = event.data) == null ? void 0 : _a.json();
  ...
  handleNotificationClick: (event) => {
    ...
    event.notification.close();
    event.waitUntil(self.clients.openWindow(((_a = event.notification.data) == null ? void 0 : _a.url) || "/"));
  },
...
const routes = {
  ...
  "routes/tidrapport_.$day": {
    id: "routes/tidrapport_.$day",
    parentId: "root",
    path: "tidrapport/:day",
    index: void 0,
    caseSensitive: void 0,
  ...
  "routes/api.time.status": {
    id: "routes/api.time.status",
    parentId: "routes/api.time",
    path: "status",
    index: void 0,
    caseSensitive: void 0,
    hasLoader: true,
  ...
  "routes/api.tidrapport": {
    id: "routes/api.tidrapport",
    parentId: "root",
    path: "api/tidrapport",
    index: void 0,
    caseSensitive: void 0,
